...
11. Power on the Virtual machine and **If you encounter a dialogue box given in the below screenshot then proceed with the following steps below,** otherwise skip to Phase 1 : Step 14 
