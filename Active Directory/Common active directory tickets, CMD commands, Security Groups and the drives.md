# Common active directory tickets, CMD commands
...
1. According to the password policy that is set in [here]([Adding a Windows computer to the AD server](Adding%20a%20Windows%20computer%20to%20the%20AD%20server.md)) . It takes 3 incorrect attempts 
